playsound block.amethyst_block.hit block @a ~ ~ ~
playsound minecraft:entity.item_frame.remove_item block @a ~ ~ ~
summon armor_stand ~ ~ ~ {NoBasePlate:1b, NoGravity:1b, Marker:1b, Small:1b, Tags:["placer"], Invisible:1b, Invulnerable:1b}
data merge block ~ ~ ~ {CustomName:'{"text":"Block Placer","color":"#8800D6"}'}
